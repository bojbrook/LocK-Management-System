...
/*
////////////////////////////////////////////////
Done in SendCommandAndACK()
//Send command
write "write data" 0x01 LSB first
write certain number of data bits

//wait for ACK
write "read status" 0x10
read one byte, response is ready if bytes is 0x01

write "read data" 0x11
read 6 bytes of ACK 00 00 FF 00 FF 00
////////////////////////////////////////////////
Done in GetFirmwareVersion(), .....
//wait for response
write "read status" 0x10
read one byte, response is ready if bytes is 0x01

write "read data" 0x11
read certain number of bytes (length of offset 4 in frame)
*/
/////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////
/*
